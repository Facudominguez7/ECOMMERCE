...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2023 a las 23:33:18
...
CREATE TABLE `archivos` (
  ...
  `ruta_web` varchar(250) NOT NULL,
  `ruta_sistema` varchar(250) NOT NULL
